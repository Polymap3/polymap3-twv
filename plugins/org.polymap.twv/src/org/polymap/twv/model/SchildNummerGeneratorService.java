 ...
 */
@Mixins(
        SchildNummerGeneratorService.Mixin.class
)
public interface SchildNummerGeneratorService
    ...
    public abstract class Mixin
            implements SchildNummerGeneratorService {

        private static final Log log = LogFactory.getLog( SchildNummerGeneratorService.class );
        ...
        public Mixin() {
            ...
            try {
                file = new File( Polymap.getWorkspacePath().toFile(), "SchildnummerGenerator.json" );
                if (file.exists()) {
        ...
        protected void storeCount() {
            ...
            try {
                ...
                throw new RuntimeException( "Fehler beim Anlegen einer neuen Schildnummer.", e );
            }
            finally {
