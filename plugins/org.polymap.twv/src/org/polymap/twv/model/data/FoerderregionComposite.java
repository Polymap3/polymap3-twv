...
@Mixins({ FoerderregionComposite.Mixin.class, PropertyChangeSupport.Mixin.class, ModelChangeSupport.Mixin.class,
...
public interface FoerderregionComposite
    ...
    public static abstract class Mixin
        ...
        public static void createInitData( NamedCreatorCallback cb ) {
            cb.create( FoerderregionComposite.class, "LEADER-Region Vorerzgebirgsregion Augustusburger Land" );
