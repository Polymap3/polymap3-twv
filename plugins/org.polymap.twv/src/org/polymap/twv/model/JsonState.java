/*
 * polymap.org Copyright 2012, Falko Br�utigam, and other contributors as indicated
 * by the @authors tag.
 * 
...
/**
 * This interface and mixin helps {@link EntityComposite}s to provide the values of
 * their properties as an {@link JSONObject}.
 * <p/>
...
public interface JsonState
     ...
     */
    public Object encodeProperty( QualifiedName name, @Optional Object value, boolean withTweaks );
     ...
     */
    public Object encodeValueComposite( QualifiedName name, @Optional ValueComposite value, boolean withTweaks );


    public Object decodeValueComposite( Class<? extends ValueComposite> type, final JSONObject value,
            final QiModule repo, final boolean withTweaks );
    ...
    public static abstract class Mixin
        ...
        // public static final FastDateFormat df = FastDateFormat.getInstance(
        // "yyyy-MM-dd' 'HH:mm" );
            ...
            try {
                ...
                // ValueComposite
                    ...
                    result.put( name.name(),
                            withTweaks ? composite.encodeValueComposite( name, (ValueComposite)value, withTweaks )
                                    : encodeValueComposite( name, (ValueComposite)value, withTweaks ) );
                }
                // property
                else {
                    result.put( name.name(), withTweaks ? composite.encodeProperty( name, value, withTweaks )
                ...
                if (type instanceof ParameterizedType) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        if (ValueComposite.class.isAssignableFrom( arrayType )) {
                            list.add( decodeValueComposite( arrayType, array.getJSONObject( i ), repo, withTweaks ) );
                        }
                        // property
                        else {
        ...
        public Object encodeValueComposite( QualifiedName name, @Optional ValueComposite value, final boolean withTweaks ) {
